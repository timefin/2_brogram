export default function Hero() {
    return (
        <>
            <h5>Complete this training program f you want to...</h5>
            ...
            <small>* The first and second set should be at 75% and 85% 
                of you working weight used for the last two sets.
            </small>
            <h3>The Training Plan</h3>
            <p>This training plan uses a structure known as the <b>Bro
             Split</b>, and follows this rotation ⬇</p>
